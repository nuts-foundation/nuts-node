...
type OAuthSession struct {
	...
	// RequestedCredentialType is the credential_type requested by the caller, used to verify the
	// issued credential's type before it is stored in the wallet.
	RequestedCredentialType string `json:"requested_credential_type,omitempty"`
