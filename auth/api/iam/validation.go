...
func (r Wrapper) validatePresentationAudience(presentation vc.VerifiablePresentation, targetAudience string) error {
	var audience []string
	...
	return oauth.OAuth2Error{
		...
		InternalError: fmt.Errorf("expected: %s, got: %v", targetAudience, audience),
	}
}
