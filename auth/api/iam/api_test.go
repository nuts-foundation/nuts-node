...
func TestWrapper_RequestServiceAccessToken(t *testing.T) {
	...
	t.Run("ok - bypass cache (client uses Cache-Control: no-cache)", func(t *testing.T) {
		...
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(response, nil).Times(2)
	...
	t.Run("ok", func(t *testing.T) {
		...
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(response, nil)
		...
		t.Run("cache expired", func(t *testing.T) {
			...
			ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(&oauth.TokenResponse{AccessToken: "other"}, nil)
	...
	t.Run("ok - no DPoP", func(t *testing.T) {
		...
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", false, nil, nil, nil).Return(&oauth.TokenResponse{}, nil)
	...
	t.Run("ok with expired cache by ttl", func(t *testing.T) {
		ctx := newTestClient(t)
		request := RequestServiceAccessTokenRequestObject{SubjectID: holderSubjectID, Body: body}
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(&oauth.TokenResponse{ExpiresIn: to.Ptr(5)}, nil)
	...
	t.Run("error - no matching credentials", func(t *testing.T) {
		ctx := newTestClient(t)
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(nil, pe.ErrNoCredentials)
	...
	t.Run("broken cache", func(t *testing.T) {
		...
		request := RequestServiceAccessTokenRequestObject{SubjectID: holderSubjectID, Body: body}
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(&oauth.TokenResponse{AccessToken: "first"}, nil)
		ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, nil, nil, nil).Return(&oauth.TokenResponse{AccessToken: "second"}, nil)
	...
	t.Run("self-asserted credentials", func(t *testing.T) {
		...
		t.Run("ok", func(t *testing.T) {
			...
			request := RequestServiceAccessTokenRequestObject{SubjectID: holderSubjectID, Body: body}
			ctx.iamClient.EXPECT().RequestRFC021AccessToken(nil, holderClientID, holderSubjectID, verifierURL.String(), "first second", true, *body.Credentials, nil, nil).Return(response, nil)
