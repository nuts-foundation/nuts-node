...
func (m *MockClient) AccessToken(ctx context.Context, code, tokenURI, callbackURI, subject, clientID, clientSecret, codeVerifier string, useDPoP bool) (*oauth.TokenResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AccessToken", ctx, code, tokenURI, callbackURI, subject, clientID, clientSecret, codeVerifier, useDPoP)
...
func (mr *MockClientMockRecorder) AccessToken(ctx, code, tokenURI, callbackURI, subject, clientID, clientSecret, codeVerifier, useDPoP any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AccessToken", reflect.TypeOf((*MockClient)(nil).AccessToken), ctx, code, tokenURI, callbackURI, subject, clientID, clientSecret, codeVerifier, useDPoP)
}
