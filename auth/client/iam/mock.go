...
func (m *MockClient) RequestRFC021AccessToken(ctx context.Context, requestHolder, verifierDID did.DID, verifierAuthorizationServerURL, scopes string, useDPoP bool) (*oauth.TokenResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RequestRFC021AccessToken", ctx, requestHolder, verifierDID, verifierAuthorizationServerURL, scopes, useDPoP)
	ret0, _ := ret[0].(*oauth.TokenResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockClientMockRecorder) RequestRFC021AccessToken(ctx, requestHolder, verifierDID, verifierAuthorizationServerURL, scopes, useDPoP any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RequestRFC021AccessToken", reflect.TypeOf((*MockClient)(nil).RequestRFC021AccessToken), ctx, requestHolder, verifierDID, verifierAuthorizationServerURL, scopes, useDPoP)
}
