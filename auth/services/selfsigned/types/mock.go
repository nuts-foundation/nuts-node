...
func (mr *MockSessionStoreMockRecorder) CheckAndSetStatus(sessionID, expectedStatus, status any) *gomock.Call {
...
func (mr *MockSessionStoreMockRecorder) Delete(sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSessionStoreMockRecorder) Load(sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSessionStoreMockRecorder) Start(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSessionStoreMockRecorder) Store(sessionID, session any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
