...
func (mr *MockSignerMockRecorder) SigningSessionStatus(ctx, sessionID any) *gomock.Call {
...
func (m *MockSigner) StartSigningSession(contract Contract, params map[string]any) (SessionPointer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSignerMockRecorder) StartSigningSession(contract, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
