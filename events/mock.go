...
func (mr *MockConnMockRecorder) JetStream(opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) ChanQueueSubscribe(subj, queue, ch any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{subj, queue, ch}, opts...)
...
func (mr *MockJetStreamContextMockRecorder) ConsumerNames(stream any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) Consumers(stream any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{stream}, opts...)
...
func (mr *MockJetStreamContextMockRecorder) DeleteKeyValue(bucket any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) DeleteObjectStore(bucket any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) ObjectStoreNames(opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) ObjectStores(opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) SecureDeleteMsg(name, seq any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{name, seq}, opts...)
...
func (mr *MockJetStreamContextMockRecorder) StreamNameBySubject(arg0 any, arg1 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJetStreamContextMockRecorder) Streams(opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionPoolMockRecorder) Acquire(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
