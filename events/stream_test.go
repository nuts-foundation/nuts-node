...
func TestStream_Subscribe(t *testing.T) {
	t.Run("subscribe works and stream is created only once", func(t *testing.T) {
		...
		jsFirst.EXPECT().Subscribe("subject", gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).Return(&nats.Subscription{}, nil)

		jsLast := NewMockJetStreamContext(ctrl)
		jsLast.EXPECT().Subscribe("subject", gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).Return(&nats.Subscription{}, nil)
	...
	t.Run("stream is not created when it exists", func(t *testing.T) {
		...
		js.EXPECT().Subscribe("subject", gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).Return(&nats.Subscription{}, nil)
	...
	t.Run("error is returned when chan-subscribe fails", func(t *testing.T) {
		...
		js := NewMockJetStreamContext(ctrl)
		js.EXPECT().StreamInfo("example").Return(mockStreamInfo, nil)
		js.EXPECT().Subscribe("subject", gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).Return(nil, errors.New("random error"))
