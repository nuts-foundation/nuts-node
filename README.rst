...
.. table:: Server Options
    ...
    tls.enabled                            true                                                                                                                                                                                                                                                                                                                 Whether to enable TLS for incoming and outgoing connections, which can be disabled for demo/development purposes. It is NOT meant for TLS offloading (see `tls.offload`).
