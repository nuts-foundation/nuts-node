...
.. table:: Server Options
    ...
    **Crypto**
    ...
    crypto.external.url                                                                                                                                                                                                                                                                                                                                        URL of the external storage service.
...
To verify that authentication is correctly configured on your node, check the ``network.auth`` status on the ``/status/health`` endpoint.
