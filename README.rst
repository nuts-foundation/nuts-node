...
- `Nuts Node status page <http://localhost:8081/status/diagnostics>`_.
...
.. table:: Server Options
    ...
    **HTTP**
    ...
    http.external.address                      \:8080                                                                                                                                                                                                                                                                                                                                                                                                  Address and port the server will be listening to for external-facing endpoints.
