...
.. table:: Server Options
    ...
    **HTTP**
    ...
    http.default.log                       metadata                                                                                                                                                                                                                                                                                                             What to log about HTTP requests. Options are 'nothing', 'metadata' (log request method, URI, IP and response code), and 'request-reply' (log the request and response body, in addition to the metadata).
