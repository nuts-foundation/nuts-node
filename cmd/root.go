...
import (
	...
	authIAMAPI "github.com/nuts-foundation/nuts-node/v6/auth/api/iam"
	authMeansAPI "github.com/nuts-foundation/nuts-node/v6/auth/api/means/v1"
	authCmd "github.com/nuts-foundation/nuts-node/v6/auth/cmd"
	"github.com/nuts-foundation/nuts-node/v6/core"
	"github.com/nuts-foundation/nuts-node/v6/core/status"
	"github.com/nuts-foundation/nuts-node/v6/crypto"
	cryptoAPI "github.com/nuts-foundation/nuts-node/v6/crypto/api/v1"
	cryptoCmd "github.com/nuts-foundation/nuts-node/v6/crypto/cmd"
	"github.com/nuts-foundation/nuts-node/v6/didman"
	didmanAPI "github.com/nuts-foundation/nuts-node/v6/didman/api/v1"
	didmanCmd "github.com/nuts-foundation/nuts-node/v6/didman/cmd"
	"github.com/nuts-foundation/nuts-node/v6/discovery"
	discoveryServerAPI "github.com/nuts-foundation/nuts-node/v6/discovery/api/server"
	discoveryAPI "github.com/nuts-foundation/nuts-node/v6/discovery/api/v1"
	discoveryCmd "github.com/nuts-foundation/nuts-node/v6/discovery/cmd"
	"github.com/nuts-foundation/nuts-node/v6/events"
	eventsCmd "github.com/nuts-foundation/nuts-node/v6/events/cmd"
	"github.com/nuts-foundation/nuts-node/v6/golden_hammer"
	goldenHammerCmd "github.com/nuts-foundation/nuts-node/v6/golden_hammer/cmd"
	httpEngine "github.com/nuts-foundation/nuts-node/v6/http"
	httpCmd "github.com/nuts-foundation/nuts-node/v6/http/cmd"
	"github.com/nuts-foundation/nuts-node/v6/jsonld"
	"github.com/nuts-foundation/nuts-node/v6/network"
	networkAPI "github.com/nuts-foundation/nuts-node/v6/network/api/v1"
	networkCmd "github.com/nuts-foundation/nuts-node/v6/network/cmd"
	...
	storageCmd "github.com/nuts-foundation/nuts-node/v6/storage/cmd"
	"github.com/nuts-foundation/nuts-node/v6/tracing"
	tracingCmd "github.com/nuts-foundation/nuts-node/v6/tracing/cmd"
	"github.com/nuts-foundation/nuts-node/v6/vcr"
	openid4vciAPI "github.com/nuts-foundation/nuts-node/v6/vcr/api/openid4vci/v0"
	vcrAPI "github.com/nuts-foundation/nuts-node/v6/vcr/api/vcr/v2"
	vcrCmd "github.com/nuts-foundation/nuts-node/v6/vcr/cmd"
	"github.com/nuts-foundation/nuts-node/v6/vdr"
	vdrAPI "github.com/nuts-foundation/nuts-node/v6/vdr/api/v1"
	vdrAPIv2 "github.com/nuts-foundation/nuts-node/v6/vdr/api/v2"
	vdrCmd "github.com/nuts-foundation/nuts-node/v6/vdr/cmd"
