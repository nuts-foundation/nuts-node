.. list-table:: did:nuts/gRPC Server Options
    ...
    * - **Storage**
      -
      -
    * - storage.bbolt.locktimeout
      - 1s
      - Maximum time to wait for acquiring a lock on the BBolt database before giving up and returning an error. Formatted as Golang duration (e.g. 1s, 1m).
