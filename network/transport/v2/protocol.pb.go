...
func (x *Envelope) GetGossip() *Gossip {
	if x != nil {
		if x, ok := x.Message.(*Envelope_Gossip); ok {
			return x.Gossip
		}
	}
	return nil
...
func (x *Envelope) GetDiagnosticsBroadcast() *Diagnostics {
	if x != nil {
		if x, ok := x.Message.(*Envelope_DiagnosticsBroadcast); ok {
...
func (x *Envelope) GetState() *State {
	if x != nil {
		if x, ok := x.Message.(*Envelope_State); ok {
			return x.State
		}
	}
	return nil
...
func (x *Envelope) GetTransactionListQuery() *TransactionListQuery {
	if x != nil {
		if x, ok := x.Message.(*Envelope_TransactionListQuery); ok {
...
func (x *Envelope) GetTransactionRangeQuery() *TransactionRangeQuery {
	if x != nil {
		if x, ok := x.Message.(*Envelope_TransactionRangeQuery); ok {
...
func (x *Envelope) GetTransactionPayloadQuery() *TransactionPayloadQuery {
	if x != nil {
		if x, ok := x.Message.(*Envelope_TransactionPayloadQuery); ok {
...
func (x *Envelope) GetTransactionSet() *TransactionSet {
	if x != nil {
		if x, ok := x.Message.(*Envelope_TransactionSet); ok {
...
func (x *Envelope) GetTransactionList() *TransactionList {
	if x != nil {
		if x, ok := x.Message.(*Envelope_TransactionList); ok {
...
func (x *Envelope) GetTransactionPayload() *TransactionPayload {
	if x != nil {
		if x, ok := x.Message.(*Envelope_TransactionPayload); ok {
...
var file_transport_v2_protocol_proto_rawDesc = string([]byte{
...
var (
	...
	file_transport_v2_protocol_proto_rawDescData []byte
)

func file_transport_v2_protocol_proto_rawDescGZIP() []byte {
	file_transport_v2_protocol_proto_rawDescOnce.Do(func() {
		file_transport_v2_protocol_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_transport_v2_protocol_proto_rawDesc), len(file_transport_v2_protocol_proto_rawDesc)))
	})
...
var file_transport_v2_protocol_proto_goTypes = []any{
...
func file_transport_v2_protocol_proto_init() {
	...
	file_transport_v2_protocol_proto_msgTypes[0].OneofWrappers = []any{
		(*Envelope_Gossip)(nil),
	...
	file_transport_v2_protocol_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_transport_v2_protocol_proto_rawDesc), len(file_transport_v2_protocol_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
