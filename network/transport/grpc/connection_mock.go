...
func (m *MockConnection) Send(protocol Protocol, envelope any, ignoreSoftLimit bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) Send(protocol, envelope, ignoreSoftLimit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) registerStream(protocol, stream any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) setPeer(peer any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) verifyOrSetPeerID(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
