...
// DiagnosticsResponse is a broadcast message for information peers of the local node's state. All fields are optional.
...
func (x *Diagnostics) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *Diagnostics) GetVendor() string {
	if x != nil {
		return x.Vendor
	}
	return ""
...
var file_transport_network_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x61, 0x22, 0xa1, 0x01, 0x0a, 0x0b, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73,
	...
	0x70, 0x65, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x70, 0x65, 0x65,
	0x72, 0x73, 0x12, 0x32, 0x0a, 0x14, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x4f, 0x66, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
	...
	0x52, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x32, 0x50, 0x0a, 0x07, 0x4e, 0x65, 0x74, 0x77,
