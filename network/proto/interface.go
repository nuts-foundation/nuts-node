...
type Protocol interface {
	...
	Configure(p2pNetwork p2p.P2PNetwork, graph dag.DAG, payloadStore dag.PayloadStore, verifier dag.DocumentSignatureVerifier, advertHashesInterval time.Duration, peerID p2p.PeerID)
