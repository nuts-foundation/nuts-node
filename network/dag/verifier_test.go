...
func (s staticKeyResolver) ResolveKeyByID(_ string, _ *time.Time, _ types.RelationType) (crypto.PublicKey, error) {
	panic("implement me")
}
...
func (s staticKeyResolver) ResolveKeyID(_ did.DID, _ types.RelationType) (ssi.URI, error) {
	panic("implement me")
}
