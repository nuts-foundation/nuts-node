...
// MockSubscriber is a mock of Notifier interface.
...
func (m *MockSubscriber) GetFailedEvents() ([]Event, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSubscriberMockRecorder) GetFailedEvents() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFailedEvents", reflect.TypeOf((*MockSubscriber)(nil).GetFailedEvents))
}

// Notify mocks base method.
func (m *MockSubscriber) Notify(event Event) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Notify", event)
}

// Notify indicates an expected call of Notify.
func (mr *MockSubscriberMockRecorder) Notify(event interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Notify", reflect.TypeOf((*MockSubscriber)(nil).Notify), event)
}
...
func (m *MockSubscriber) Save(tx go_stoabs.WriteTx, event Event) error {
	m.ctrl.T.Helper()
...
func (mr *MockSubscriberMockRecorder) Save(tx, event interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockSubscriber)(nil).Save), tx, event)
}
