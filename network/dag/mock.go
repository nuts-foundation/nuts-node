...
func (mr *MockStateMockRecorder) Add(ctx, transactions, payload any) *gomock.Call {
...
func (mr *MockStateMockRecorder) FindBetweenLC(ctx, startInclusive, endExclusive any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) Head(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) IBLT(reqClock any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) IsPayloadPresent(ctx, payloadHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) IsPresent(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) Notifier(name, receiver any, filters ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) ReadPayload(ctx, payloadHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) Verify(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) WritePayload(ctx, transaction, payloadHash, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) XOR(reqClock any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// isPayloadPresent indicates an expected call of isPayloadPresent.
func (mr *MockPayloadStoreMockRecorder) isPayloadPresent(tx, payloadHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// readPayload indicates an expected call of readPayload.
func (mr *MockPayloadStoreMockRecorder) readPayload(tx, payloadHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// writePayload indicates an expected call of writePayload.
func (mr *MockPayloadStoreMockRecorder) writePayload(tx, payloadHash, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
