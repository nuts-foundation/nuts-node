...
func FlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("network.enabletls", defs.EnableTLS, "Whether to enable TLS for gRPC connections. "+
	...
	flagSet.String("network.tls.offload", string(defs.TLS.Offload), "Whether to enable TLS offloading for incoming connections. If enabled `network.tls.offload` must be configured as well.")
