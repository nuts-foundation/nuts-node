...
func FlagSet() *pflag.FlagSet {
	...
	flagSet.String("network.nats.hostname", defs.ProtocolV2.Nats.Hostname, "Hostname for the NATS server")
	flagSet.Int("network.nats.port", defs.ProtocolV2.Nats.Port, "Port where the NATS server listens on")
	flagSet.Int("network.nats.timeout", defs.ProtocolV2.Nats.Timeout, "Timeout (in seconds) for the NATS connection")
