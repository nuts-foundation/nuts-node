...
// Package dcql implements Digital Credentials Query Language (DCQL) credential matching
// as specified in OpenID4VP section 6.1 and 6.3.
package dcql
...
func Match(query CredentialQuery, credentials []vc.VerifiableCredential) []vc.VerifiableCredential {
