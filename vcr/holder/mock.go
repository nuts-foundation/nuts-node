...
func (m *MockWallet) BuildSubmission(ctx context.Context, walletDIDs []did.DID, presentationDefinition pe.PresentationDefinition, acceptedFormats map[string]map[string][]string, params BuildParams) (*vc.VerifiablePresentation, *pe.PresentationSubmission, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildSubmission", ctx, walletDIDs, presentationDefinition, acceptedFormats, params)
	ret0, _ := ret[0].(*vc.VerifiablePresentation)
...
func (mr *MockWalletMockRecorder) BuildSubmission(ctx, walletDIDs, presentationDefinition, acceptedFormats, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildSubmission", reflect.TypeOf((*MockWallet)(nil).BuildSubmission), ctx, walletDIDs, presentationDefinition, acceptedFormats, params)
}
