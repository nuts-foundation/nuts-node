...
func (m memoryWallet) BuildSubmission(ctx context.Context, walletDIDs []did.DID, additionalCredentials map[did.DID][]vc.VerifiableCredential, presentationDefinition pe.PresentationDefinition, credentialQueries []dcql.CredentialQuery, params BuildParams) (*vc.VerifiablePresentation, *pe.PresentationSubmission, error) {
	...
	return presenter{
		...
		signer:         m.signer,
		keyResolver:    m.keyResolver,
	}.buildSubmission(ctx, wallets, presentationDefinition, credentialQueries, params)
}
