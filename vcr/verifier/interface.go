...
type Verifier interface {
	...
	// If verifyVCs is true, it will also verify the credentials inside the VP, checking their correctness, signature and trust status (unless verifyVCsTrusted is false).
	VerifyVP(presentation vc.VerifiablePresentation, verifyVCs bool, verifyVCsTrusted bool, validAt *time.Time) ([]vc.VerifiableCredential, error)
}
