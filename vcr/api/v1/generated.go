...
type CreateVerifiablePresentationRequest struct {
...
// CreateVerifiablePresentationJSONBody defines parameters for CreateVerifiablePresentation.
type CreateVerifiablePresentationJSONBody CreateVerifiablePresentationRequest
...
// CreateVerifiablePresentationJSONRequestBody defines body for CreateVerifiablePresentation for application/json ContentType.
type CreateVerifiablePresentationJSONRequestBody CreateVerifiablePresentationJSONBody
...
type ClientInterface interface {
	...
	// CreateVerifiablePresentation request with any body
	CreateVerifiablePresentationWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateVerifiablePresentation(ctx context.Context, body CreateVerifiablePresentationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateVerifiablePresentationWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateVerifiablePresentationRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateVerifiablePresentation(ctx context.Context, body CreateVerifiablePresentationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateVerifiablePresentationRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewCreateVerifiablePresentationRequest calls the generic CreateVerifiablePresentation builder with application/json body
func NewCreateVerifiablePresentationRequest(server string, body CreateVerifiablePresentationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateVerifiablePresentationRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateVerifiablePresentationRequestWithBody generates requests for CreateVerifiablePresentation with any type of body
func NewCreateVerifiablePresentationRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/internal/vcr/v1/vp")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// CreateVerifiablePresentation request with any body
	CreateVerifiablePresentationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateVerifiablePresentationResponse, error)

	CreateVerifiablePresentationWithResponse(ctx context.Context, body CreateVerifiablePresentationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateVerifiablePresentationResponse, error)
...
type CreateVerifiablePresentationResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r CreateVerifiablePresentationResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateVerifiablePresentationResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// CreateVerifiablePresentationWithBodyWithResponse request with arbitrary body returning *CreateVerifiablePresentationResponse
func (c *ClientWithResponses) CreateVerifiablePresentationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateVerifiablePresentationResponse, error) {
	rsp, err := c.CreateVerifiablePresentationWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateVerifiablePresentationResponse(rsp)
}

func (c *ClientWithResponses) CreateVerifiablePresentationWithResponse(ctx context.Context, body CreateVerifiablePresentationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateVerifiablePresentationResponse, error) {
	rsp, err := c.CreateVerifiablePresentation(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateVerifiablePresentationResponse(rsp)
...
// ParseCreateVerifiablePresentationResponse parses an HTTP response from a CreateVerifiablePresentationWithResponse call
func ParseCreateVerifiablePresentationResponse(rsp *http.Response) (*CreateVerifiablePresentationResponse, error) {
	bodyBytes, err := ioutil.ReadAll(rsp.Body)
	defer rsp.Body.Close()
	if err != nil {
		return nil, err
	...
	response := &CreateVerifiablePresentationResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	// (POST /internal/vcr/v1/vp)
	CreateVerifiablePresentation(ctx echo.Context) error
...
// CreateVerifiablePresentation converts echo context to params.
func (w *ServerInterfaceWrapper) CreateVerifiablePresentation(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.CreateVerifiablePresentation(ctx)
	return err
}
...
func (w *ServerInterfaceWrapper) Search(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.Search(ctx, concept, params)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.Add(http.MethodPost, baseURL+"/internal/vcr/v1/vp", func(context echo.Context) error {
		si.(Preprocessor).Preprocess("CreateVerifiablePresentation", context)
		return wrapper.CreateVerifiablePresentation(context)
	})
