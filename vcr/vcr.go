...
import (
	...
	"github.com/nuts-foundation/nuts-node/v5/vcr/assets"
...
func (c *vcr) Configure(config core.ServerConfig) error {
	...
	if c.config.OpenID4VCI.Enabled {
		...
		issuerTransport := httpclient.SafeHttpTransport.Clone()
		...
		walletTransport := httpclient.SafeHttpTransport.Clone()
