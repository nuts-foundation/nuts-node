...
func FlagSet() *pflag.FlagSet {
	...
	flagSet.StringToString("vcr.jsonldcontexts.localmapping", defs.JSONLDContexts.LocalFileMapping, "This setting allows mapping external urls to local files for e.g. preventing external dependencies. A source presented here has precedence over the remoteallowlist.")
	return flagSet
}
