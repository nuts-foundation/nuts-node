...
// MethodCreationOption limits DID creation to a single method
type MethodCreationOption struct {
	Method string
}
...
// EmptyCreationOptions returns an empty CreationOptions instance.
func EmptyCreationOptions() CreationOptions {
