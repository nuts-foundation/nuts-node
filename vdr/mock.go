...
func (m *MockVDR) DocumentOwner() management.DocumentOwner {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DocumentOwner")
	ret0, _ := ret[0].(management.DocumentOwner)
	return ret0
}
...
func (m *MockVDR) NutsDocumentManager() management.DocumentManager {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NutsDocumentManager")
	ret0, _ := ret[0].(management.DocumentManager)
	return ret0
}
