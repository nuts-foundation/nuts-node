...
func TestVDRIntegration_Test(t *testing.T) {
	...
	assert.Len(t, resolvedDoc.Service, 1,
		"resolved doc should have a service")
	assert.Equal(t, newService, resolvedDoc.Service[0],
		"expected resolved doc service to be equal to the new service")
