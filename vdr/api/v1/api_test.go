...
func TestWrapper_CreateDID(t *testing.T) {
	...
	t.Run("ok - defaults", func(t *testing.T) {
		...
		ctx.nutsDocumentManager.EXPECT().Create(gomock.Any(), management.EmptyCreationOptions()).Return(didDoc, nil, nil)
...
type mockContext struct {
	...
	nutsDocumentManager *management.MockDocumentManager
	client              *Wrapper
...
func newMockContext(t *testing.T) mockContext {
	...
	nutsDocumentManager := management.NewMockDocumentManager(ctrl)
