...
func (m *MockDocumentManager) DeleteService(ctx context.Context, subjectDID did.DID, serviceID go_did.URI) error {
	m.ctrl.T.Helper()
...
func (m *MockDocumentManager) UpdateService(ctx context.Context, subjectDID did.DID, serviceID go_did.URI, service did.Service) (*did.Service, error) {
	m.ctrl.T.Helper()
...
// DeleteService mocks base method.
func (m *MockSubjectManager) DeleteService(ctx context.Context, subject string, serviceID go_did.URI) error {
	m.ctrl.T.Helper()
...
// UpdateService mocks base method.
func (m *MockSubjectManager) UpdateService(ctx context.Context, subject string, serviceID go_did.URI, service did.Service) ([]did.Service, error) {
	m.ctrl.T.Helper()
