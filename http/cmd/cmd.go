...
func FlagSet() *pflag.FlagSet {
	...
	flags.String("http.default.auth.type", string(defs.Auth.Type), fmt.Sprintf("Whether to enable authentication for the default interface, specify '%s' for bearer token authentication.", http.BearerTokenAuthV2))
