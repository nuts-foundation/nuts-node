...
// A creation request for a compound service that references endpoints and/or endpoints.
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.Add(http.MethodGet, baseURL+"/internal/didman/v1/did/:did/compoundservice/:compoundServiceType/endpoint/:endpointType", func(context echo.Context) error {
